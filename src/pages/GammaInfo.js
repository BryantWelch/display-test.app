...
const GammaInfo = () => {
  ...
  return (
    <PageContainer>
      ...
      <Subtitle>
        Use this test to estimate your display&apos;s effective gamma and check whether midtones look too
        bright or too dark. Rows of gray steps help you match your monitor to common targets like gamma
        2.2.
      </Subtitle>
